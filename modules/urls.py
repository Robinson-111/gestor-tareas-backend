...
urlpatterns = [
    ...
    path('<int:id>/members/', MembersModuleView.as_view(), name='members_module_list'),
    path('<int:id>/members/<int:user_id>/', MembersModuleView.as_view(), name='members_module_delete')
]